...
public class EssayController {
    ...
    public EssayController(PostService postService, CommentService commentService, UserService userService,
    ...
    public String listPosts(Model model,
        ...
        Page<Post> posts = postService.getPostsByCategoryAndMonth(PostCategory.ESSAY, pageable, startDate, endDate, sort);
...
//                throw new RuntimeException("이미지가 선택되지 않았습니다.");
        ...
        Post newPost = postService.createPost(title, content, author, PostCategory.ESSAY, fontClass, imageUrl);
        ...
        return "redirect:/essay";  // 성공적으로 생성 후 게시글 목록 페이지로 이동
    }
...
//        comment.setPost(post);
    ...
    public String filterPostsByMonth(
        ...
        if (startDate != null && endDate != null) {
            posts = postService.getPostsByCategoryAndMonth(PostCategory.ESSAY, pageable, startDate, endDate, sort);
        } else {
            posts = postService.getPostsByCategorySorted(PostCategory.ESSAY, pageable, sort);
        }
